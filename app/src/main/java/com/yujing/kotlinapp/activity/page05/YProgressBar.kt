...
class YProgressBar : Dialog {
    ...
    private val view: LinearLayout
        get() {
            ...
            val mProgressBar = ProgressBar(context, null, android.R.attr.progressBarStyle)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val strokeColor = Color.parseColor("#303A89FF")//边框颜色
        val fillColor = Color.parseColor("#A0000000")//内部填充颜色
    ...
    companion object {
        ...
        fun show(activity: Activity?, message1: String?, message2: String?, isCancelable: Boolean) {
            ...
            if (activity == null || activity.isFinishing)
                return
            dialog = YProgressBar(activity, message1, message2, isCancelable)
            dialog!!.show()
        }
        ...
        fun setColor(@ColorInt color: Int) {
            dialog?.setProgressBarColor(color)
        }
